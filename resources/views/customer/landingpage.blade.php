      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div
            ...
            <p>Pencucian dilakukan dengan deterjen cair khusus yang mengandung surfaktan non-ionik dan anti-redoposisi,
              serta bahan pembentuk emulsi yang menyebabkan kotoran terlepas dengan sempurna dari serat pakaian.
              Kemudian pakaian dikeringkan dengan mesin pengering tanpa dijemur sehingga bebas bau matahari dan debu
              udara.
              Selanjutnya penyetrikaan dilakukan dengan menggunakan setrika uap boiler sehingga aman untuk pakaian
              dengan
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('land/img/testimonials/tes-2.png') }}" class="testimonial-img" alt="">
                <h3>Ari Gunawan</h3>
                <h4>Customer</h4>
                <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('land/img/testimonials/tes-1.png') }}" class="testimonial-img" alt="">
                <h3>Agung</h3>
                <h4>Customer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('land/img/testimonials/testimonials-3.jpg') }}" class="testimonial-img" alt="">
                <h3>Tyan</h3>
                <h4>Customer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('land/img/testimonials/testimonials-4.jpg') }}" class="testimonial-img" alt="">
                <h3>Zacky</h3>
                <h4>Customer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{ asset('land/img/testimonials/testimonials-5.jpg') }}" class="testimonial-img" alt="">
                <h3>Zen</h3>
                <h4>Customer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="{{ asset('land/img/team/team-1.jpg') }}" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="{{ asset('land/img/team/team-2.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Sarah Jhonson</h4>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              <div class="pic"><img src="{{ asset('land/img/team/team-3.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="member" data-aos="zoom-in" data-aos-delay="400">
              <div class="pic"><img src="{{ asset('land/img/team/team-4.jpg') }}" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Amanda Jepson</h4>
          ...
          <ul>
            <li data-aos="fade-up">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse"
                data-bs-target="#faq-list-1">Apa itu Karisma Laundry ? <i class="bx bx-chevron-down icon-show"></i><i
                  class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  Karisma Laundry sebagai Laundry yang memiliki harga yang lebih terjangkau dari pesaing lain. Selain
                  itu
                  kalian bisa melihat status Laundry melalui website tanpa harus datang ke Outlet kami. Dan kami
                  selalu memberikan promo dan pelayanan yang terbaik. Dijamin tidak akan kecewa dengan pelayanan kami
                </p>
              </div>
            </li>

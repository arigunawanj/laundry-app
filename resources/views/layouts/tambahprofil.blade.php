                        ...
                        <div class="col-md-12">
                            <form action="{{ route('profile.store') }}" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="d-none mb-3">
                                    ...
                                    <input type="number" readonly name="id" value="{{ Auth::user()->id }}" id="" class="form-control">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" min="0" name="telephone" id="simpleinput" class="form-control">
                                </div>

                                <div class="d-none mb-3">
                                    <label for="simpleinput">ID User</label>
                                    <input type="number" readonly name="user_id" value="{{ Auth::user()->id }}" id="" class="form-control">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="simpleinput">Foto</label>
                                    <input type="file" min="0" name="image" required id="simpleinput" class="form-control">
                                </div>
